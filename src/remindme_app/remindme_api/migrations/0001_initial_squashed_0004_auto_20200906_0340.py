# Generated by Django 3.1.1 on 2020-09-06 06:34

import django.db.models.deletion
from django.conf import settings
from django.db import migrations, models

import remindme_api.validators


class Migration(migrations.Migration):
    replaces = [('remindme_api', '0001_initial'), ('remindme_api', '0002_auto_20200904_1845'),
                ('remindme_api', '0003_remindertask'), ('remindme_api', '0004_auto_20200906_0340')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurs_at', models.DateTimeField(validators=[remindme_api.validators.must_be_future_datetime])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timezone', models.CharField(choices=[('Africa/Abidjan', 'Africa/Abidjan'), ('Africa/Accra', 'Africa/Accra'),
                                                       ...
                                                       ('Asia/Ulan_Bator', 'Asia/Ulan_Bator'), ('Asia/Urumqi', 'Asia/Urumqi'),
                                                       ...
                                                       ('Zulu', 'Zulu')], default='UTC', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reminder', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='remindme_api.reminder')),
            ],
        ),
    ]
